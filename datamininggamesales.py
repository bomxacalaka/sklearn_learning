...
for page in range(1, pages):
    ...
    for tag in game_tags:
        ...
        try:
            ...
            print(f"{rec_count + 1}, Page: {page}, Fetch data for game {gname[-1]}")
            ...
            print(f"Page: {page}, Game {tag.string} not found")
            continue
    ...
    if os.path.exists('game_sales_data.csv'):
        df.to_csv('game_sales_data.csv', mode='a', header=False)
